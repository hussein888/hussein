...
git clone https://github.com/hussein888/hussein
...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf hussein-bot && rm -rf .telegram-cli && git clone https://githubgit clone https://github.com/hussein888/hussein-bot.git && cd superflux-bot && ./launch.sh install && ./launch.sh
~~~~~
